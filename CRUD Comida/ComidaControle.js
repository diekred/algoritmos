...
function salvar() {
    ...
    if (id && nome && peso && distribuidora) {// se tudo certo 
        switch (oQueEstaFazendo) {
            case 'inserindo':
                comida = new Comida(id, nome, peso, distribuidora);
                listaComida.push(comida);
                mostrarAviso("Inserido na lista");
                break;
            case 'alterando':
                comidaAlterado = new Comida(id, nome, peso, distribuidora);
...
function mostrarDadosComida(comida) {
    ...
    document.getElementById("inputDistribuidora").value = comida.distribuidora;
